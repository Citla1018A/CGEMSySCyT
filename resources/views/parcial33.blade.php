...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div class="container">
      <form enctype="multipart/form-data" action="generatePDF" method="POST">
      @csrf
      <div class="row">
        <div class="col"></div>
            <div class="col">
                <h1 style="font-weight: 700;font-size: 2.2rem;margin-bottom: 1px; text-align: center;">Certificado Parcial</h1>
                <h1 style="font-weight: 700;font-size: 2.2rem;margin-bottom: 1px; text-align: center;">Plan 33</h1>
            </div>
        <div class="col"></div>
      </div>
